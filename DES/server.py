...
if not data:
break
ciphertext, encrypt_results = des_encrypt(message, key)
# Print intermediate results
print("\nIntermediate Results (IP, Round 1, 2, ..., 16) in HEX format:")
formatted_encrypt_results = format_round_states(encrypt_results)
for i, result in enumerate(formatted_encrypt_results):
if i+1==17:
break
