...
class AesFromScratch:
    ...
    def initTables(self):
        ...
        self.GaloisF2 = [i << 1 if i < 128 else ((i << 1) ^ 0x1b) & 0xff for i in range(256)]
        self.GaloisF3 = [self.GaloisF2[i] ^ i for i in range(256)]
        # RCON table for up to ten rounds
        self.RCON =["01", "02", "04", "08", "10", "20", "40","80", "1b",
        "36","25","64","43","20","21","26"]
